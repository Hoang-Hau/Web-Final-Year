...
import { foodTypes, sortTypes } from "../constants/action.types";
...
export const deleteRestaurant = (id) => async (dispatch, getState) => {
  ...
  let res;
  try {
    res = await axios.get("http://localhost:8080/admin/deleterestaurant/" + id);
  } catch (err) {
    console.log(err);
    return;
  }
  ...
  try {
    res = await axios.get(
      "http://localhost:8080/category/all/" +
        getState().foodReducers.category.page
    );
  } catch (err) {
    return;
  }
  ...
  try {
    res = await axios.get(
      "http://localhost:8080/restaurant/all/" +
        getState().foodReducers.restaurant.page
    );
  } catch (err) {
    return;
  }
  ...
  try {
    res = await axios.get(
      "http://localhost:8080/publisher/all/" +
        getState().foodReducers.publisher.page
    );
  } catch (err) {
    return;
  }
...
export const getAuthor = () => async (dispatch, getState) => {
  ...
  try {
    res = await axios.get(
      "http://localhost:8080/author/all/" + getState().foodReducers.author.page
    );
  } catch (err) {
    return;
  }
